...
//writeMKMJSONToDB($conn, 'data/magiccardmarket/result/2017/September/4.json');
//updateGoldfishJSONToDB($conn, 'data/mtggoldfish/result/2017/September/4.json');
